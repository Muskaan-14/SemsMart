    ...
    <>
      <Navbar bg="dark" variant="dark" expand="lg" className="py-2">
        <Container>
          ...
          <Form inline className="d-flex align-items-center">
            <FormControl type="text" placeholder="Find Cars, Mobile Phones and more..." className="mr-2" />
            <Button variant="outline-light" className="mr-2">Search</Button>
          </Form>
          ...
          <Nav className="ml-auto d-flex align-items-center">
            ...
            <div className="d-flex align-items-center">
              <img src="./images/user.jpg" alt="User" width="40" height="35" style={{ marginLeft: "15px", marginRight:"1px" }} />
              <Dropdown>
                <Dropdown.Toggle variant="dark" id="dropdown-profile" style={{ padding: '2px 10px', fontSize: '20px', height: '30px',  border: 'none', background: 'transparent', boxShadow: 'none' }}>
                </Dropdown.Toggle>
                <Dropdown.Menu>
      ...
      <Navbar bg="light" variant="light" className="py-2 border-top">
        <Container>
          <Nav className="w-100">
            <Dropdown>
              ...
              <Dropdown.Menu>
                {categories.map((category, index) => (
                  <Dropdown.Item key={index} as={Link} to={`/home/categories/${category}`}>
                    {category}
                  </Dropdown.Item>
                ))}
              </Dropdown.Menu>
            ...
            {/* Render category links */}
            {categories.map((category, index) => (
              <Nav.Link key={index} as={Link} to={`/home/categories/${category}`} className="ml-3">
                {category}
              </Nav.Link>
            ))}
          </Nav>
